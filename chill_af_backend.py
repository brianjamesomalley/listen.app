...
app = Flask(__name__)  # fix: **name** -> __name__
...
def handle_crash():
    ...
    })  # fix: stray code-block markdown removed, proper indentation throughout
...
def crash_stats():
    ...
    })  # fix: stray code-block markdown removed
...
if __name__ == '__main__':  # fix: **name** == '**main**' -> __name__ == '__main__'
